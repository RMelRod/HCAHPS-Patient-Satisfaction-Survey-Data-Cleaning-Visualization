...
If the hospital performs well (partially determined by the percentage of "top box" answers from the HCAHPS survey), they will receive a payment increase based on their total reimbursement for that year. The best hospitals will receive up to 2% with a bonus.
